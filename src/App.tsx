      ...
      {showIntro ? (
        ...
        <div className="relative h-screen bg-black">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute w-[200%] h-[200%] bg-[url('/star.png')] bg-repeat animate-star1"></div>
            <div className="absolute w-[200%] h-[200%] bg-[url('/star.png')] bg-repeat animate-star2"></div>
            <div className="absolute w-[200%] h-[200%] bg-[url('/star.png')] bg-repeat animate-star3"></div>
          </div>
